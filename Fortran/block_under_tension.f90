...
real *8 fncst(totnode,3), fncstold(totnode,3), disp(totnode,3), vel(totnode,3), velhalfold(totnode,3), velhalf(totnode,3), andisp(totnode,3)
...
write(*,*) 'fncst = ', fncst(totnode,1) , fncst(totnode,2), fncst(totnode,3)
